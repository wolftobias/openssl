...
ASN1_SEQUENCE(DECLARATION_OF_MAJORITY_SYNTAX) = {
    ASN1_IMP(DECLARATION_OF_MAJORITY_SYNTAX, notYoungerThen, ASN1_INTEGER, 0),
    ASN1_IMP_SEQUENCE(DECLARATION_OF_MAJORITY_SYNTAX, fullAgeAtCountry, FULL_AGE_AT_COUNTRY, 1),
    ASN1_IMP(DECLARATION_OF_MAJORITY_SYNTAX, dateOfBirth, ASN1_GENERALIZEDTIME, 2),
 } ASN1_SEQUENCE_END(DECLARATION_OF_MAJORITY_SYNTAX)
