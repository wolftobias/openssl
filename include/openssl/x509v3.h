...
typedef struct MonetaryLimitSyntax_st {
    ASN1_PRINTABLESTRING* currency;
    ASN1_INTEGER* amount;
    ASN1_INTEGER* exponent;
} MONETARY_LIMIT_SYNTAX;

DECLARE_ASN1_ITEM(MONETARY_LIMIT_SYNTAX)
...
typedef struct FullAgeAtCountry_st { 
    ASN1_BOOLEAN* fullAge;
    ASN1_PRINTABLESTRING* country;
} FULL_AGE_AT_COUNTRY;
...
DECLARE_ASN1_ITEM(DECLARATION_OF_MAJORITY_SYNTAX)

DECLARE_ASN1_FUNCTIONS(FULL_AGE_AT_COUNTRY)
DECLARE_ASN1_FUNCTIONS(DECLARATION_OF_MAJORITY_SYNTAX)
    
typedef STACK_OF(X509_ATTRIBUTE) SUBJECT_DIRECTORY_ATTRIBUTES;
DECLARE_ASN1_FUNCTIONS(SUBJECT_DIRECTORY_ATTRIBUTES)
    
typedef B_ASN1_DIRECTORYSTRING RESTRICTION_SYNTAX;
